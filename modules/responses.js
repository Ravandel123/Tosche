...
function resRate(subject) {
   ...
   // const firstPartArray = ['', 'Hmm. I\'d rate that ', 'I\'d give that ', 'I\'d say '];
   // const personifiedFirstPartArray = ['', 'Hmm. I\'d rate you ', 'I\'d give you a ', 'I\'d say '];
